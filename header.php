...
<head>
	...
	<title><?php bloginfo('name');
			is_home() ? bloginfo() : wp_title('||'); ?></title>
...
<body <?php body_class(); ?>>
	...
	<div class="<?php if (is_page('homepage')) {
					echo "navbar";
				} else {
					echo "navbar__white";
				} ?>">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-3 d-none d-lg-block nav-social-wrap">
					<?php
					if (is_page('homepage')) {
						if (have_rows('social_links_header',  'option')) : ?>
						...
						if (have_rows('social_links_header_grey',  'option')) : ?>
							<div class="nav-social">
								<?php while (have_rows('social_links_header_grey',  'option')) :
									the_row();
									$link__header = get_sub_field('link');
									$icon__header = get_sub_field('icon');
								?>
